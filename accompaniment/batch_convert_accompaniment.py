...
# -*- coding: utf-8 -*-
"""
Batch conversion script (accompaniment): convert JSON files in the json/ dir to WAV
"""
import json
import os
import subprocess
...
def convert_json_to_midi(json_path, midi_path):
    """Convert JSON to MIDI with DoMuse.exe"""
...
def main():
    ...
    print(f"Found {total} accompaniment JSON files, starting batch conversion...\n", flush=True)
